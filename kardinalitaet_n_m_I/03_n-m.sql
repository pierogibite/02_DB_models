...
# Servants: Inserts
INSERT INTO design.servants (servant_id, servant_name, yrs_served) VALUES (DEFAULT, "Hasan", 5);
INSERT INTO design.servants (servant_id, servant_name, yrs_served) VALUES (DEFAULT, "Dimitrij", 3);
...
(
  purchase_id          INT       NOT NULL AUTO_INCREMENT COMMENT 'PK',
  servant_id INT       NOT NULL COMMENT 'FK',
...
#- Purchases: Inserts (Kaufprozesse : Käufer - Produkt)
#- Purchases: Inserts (Kaufprozesse : Käufer - Produkt)
INSERT INTO design.purchases (purchase_id, servant_id, product_id, p_time) VALUES 
(DEFAULT, 1 , 2, DEFAULT),
(DEFAULT, 1, 3, DEFAULT), 
(DEFAULT, 2, 1, DEFAULT),
(DEFAULT, 2, 2, DEFAULT),
